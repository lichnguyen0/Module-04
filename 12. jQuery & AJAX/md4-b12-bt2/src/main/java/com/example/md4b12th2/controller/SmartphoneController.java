package com.example.md4b12th2.controller;

import com.example.md4b12th2.model.Smartphone;
import com.example.md4b12th2.service.ISmartphoneService;
...
public class SmartphoneController {
    ...
    public ResponseEntity<Smartphone> updateSmartphone(@PathVariable Long id, @RequestBody Smartphone smartphone) {
        ...
        Smartphone s = existing.get();
        s.setProducer(smartphone.getProducer());
        s.setModel(smartphone.getModel());
        s.setPrice(smartphone.getPrice());
        smartphoneService.save(s);
